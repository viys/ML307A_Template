...
#define OPENCPU_TEST_UARTTX_IOMUX CM_IOMUX_PIN_14, CM_IOMUX_FUNC_FUNCTION1
#define OPENCPU_TEST_UARTRX_IOMUX CM_IOMUX_PIN_15, CM_IOMUX_FUNC_FUNCTION1
#endif
...
#define OPENCPU_TEST_PWM2_IOMUX 0, 0
#endif
